...
urlpatterns = [
    ...
    url(r'^administracija/komentar_vozilo/(?P<komentar_id>[0-9]+)/$', views.komentar_vozilo_detail, name='komentar_za_vozilo-detail'),
    ...
    url(r'^administracija/izmena_komentara_vozilo/(?P<komentar_id>[0-9]+)/$', views.komentar_vozilo_update, name='komentar_vozilo-update'),
    ...
    url(r'^administracija/novi_komentar_vozilo/(?P<vozilo_id>[0-9]+)/$', views.create_vozilo_komentar, name='komentar_vozilo-add'),
    ...
    url(r'^administracija/(?P<vozilo_id>[0-9]+)/obrisi_komentar_vozilo/(?P<komentar_id>[0-9]+)/$', views.komentar_vozilo_delete, name='komentar_za_vozilo-delete'),
